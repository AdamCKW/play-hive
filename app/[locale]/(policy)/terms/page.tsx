export default function TermsPage() {
    return (
        <div className="mx-auto my-4 w-full max-w-[600px] space-y-4 px-4 text-justify">
            <h1 className="text-2xl font-bold">Terms and Conditions</h1>

            <p>Welcome to PlayHive!</p>

            <p>
                These terms and conditions outline the rules and regulations for
                the use of PlayHive&apos;s Website, located at
                playhive.vercel.app.
            </p>

            <p>
                By accessing this website we assume you accept these terms and
                conditions. Do not continue to use PlayHive if you do not agree
            ...
            <p>
                ...
                accordance with and subject to, prevailing law of my. Any use of
            ...
            <p>
                We employ the use of cookies. By accessing PlayHive, you agreed
                to use cookies in agreement with the PlayHive&apos;s Privacy
                Policy.{" "}
            </p>
            ...
            <p>
                Unless otherwise stated, PlayHive and/or its licensors own the
                intellectual property rights for all material on PlayHive. All
                intellectual property rights are reserved. You may access this
                from PlayHive for your own personal use subjected to
                restrictions set in these terms and conditions.
            </p>

            <p>You must not:</p>
            <ul className="list-outside list-decimal pl-8">
                <li>Republish material from PlayHive</li>
                <li>Sell, rent or sub-license material from PlayHive</li>
                <li>Reproduce, duplicate or copy material from PlayHive</li>
                <li>Redistribute content from PlayHive</li>
            </ul>

            <p>This Agreement shall begin on the date hereof 27/10/2023.</p>

            <p>
                Parts of this website offer an opportunity for users to post and
                exchange opinions and information in certain areas of the
                website. PlayHive does not filter, edit, publish or review
                Comments prior to their presence on the website. Comments do not
                reflect the views and opinions of PlayHive,its agents and/or
                affiliates. Comments reflect the views and opinions of the
                person who post their views and opinions. To the extent
                permitted by applicable laws, PlayHive shall not be liable for
            ...
            <p>
                PlayHive reserves the right to monitor all Comments and to
            ...
            <p>
                You hereby grant PlayHive a non-exclusive license to use,
            ...
            <p>
                ...
                of PlayHive; and (d) the link is in the context of general
            ...
            <p>
                ...
                by sending an e-mail to PlayHive. Please include your name, your
            ...
            <p>
                No use of PlayHive&apos;s logo or other artwork will be allowed

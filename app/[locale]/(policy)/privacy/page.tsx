export default function PrivacyPage() {
    return (
        <div className="mx-auto my-4 w-full max-w-[600px] space-y-4 px-4 text-justify">
            <h1 className="text-2xl font-bold">Privacy Policy for PlayHive</h1>

            <p>
                At PlayHive, accessible from playhive.vercel.app, one of our
                ...
                and recorded by PlayHive and how we use it.
            </p>
            ...
            <p>
                ...
                information that they shared and/or collect in PlayHive. This
            ...
            <p>
                PlayHive follows a standard procedure of using log files. These
            ...
            <p>
                Like any other website, PlayHive uses &quot;cookies&quot;. These
            ...
            <p>
                ...
                the advertising partners of PlayHive.
            </p>

            <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on PlayHive,
            ...
            <p>
                Note that PlayHive has no access to or control over these
            ...
            <p>
                PlayHive&apos;s Privacy Policy does not apply to other
            ...
            <p>
                (i) Request that a business that collects a consumer&apos;s
                personal data disclose the categories and specific pieces of
                personal data that a business has collected about consumers.
            </p>
            <p>
                (ii) Request that a business delete any personal data about the
                consumer that a business has collected.
            </p>
            <p>
                (iii) Request that a business that sells a consumer&apos;s
            ...
            <p>
                (i) The right to access – You have the right to request copies
                of your personal data. We may charge you a small fee for this
                service.
            </p>
            <p>
                (ii) The right to rectification – You have the right to request
            ...
            <p>
                (iii) The right to erasure – You have the right to request that
                we erase your personal data, under certain conditions.
            </p>
            <p>
                (iv) The right to restrict processing – You have the right to
                request that we restrict the processing of your personal data,
                under certain conditions.
            </p>
            <p>
                (v) The right to object to processing – You have the right to
                object to our processing of your personal data, under certain
                conditions.
            </p>
            <p>
                (vi) The right to data portability – You have the right to
            ...
            <p>
                PlayHive does not knowingly collect any Personal Identifiable
            ...
            <p>
                ...
                Policy, do not hesitate to contact us at example@email.com.
            </p>
        </div>
    );
}

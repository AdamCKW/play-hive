export default function CookiesPage() {
    return (
        <div className="mx-auto my-4 w-full max-w-[600px] space-y-4 px-4 text-justify">
            <h1 className="text-2xl font-bold">Cookie Policy for PlayHive</h1>
            ...
            <h2 className="text-xl font-bold">Disabling Cookies</h2>
            ...
            <h2 className="text-xl font-bold">The Cookies We Set</h2>

            <ul className="list-outside list-decimal pl-8">
                <li>
                    <p className="font-bold">Account related cookies</p>
                    <p>
                ...
                <li>
                    <p className="font-bold">Login related cookies</p>
                    <p>
                ...
                <li>
                    <p className="font-bold">Site preferences cookies</p>
                    <p>
            ...
            <p>
                ...
                <a href="#">the Cookies Policy article</a>.
            </p>

            <p>
                However if you are still looking for more information then you
                can contact us through playhive@example.com
            </p>
        </div>
    );
}
